      ...
      <div className="container mx-auto px-8 md:px-12 lg:px-16">
        <div className="grid lg:grid-cols-3 md:grid-cols-2 gap-8 mb-8">
          <div>
            ...
            <p className="text-gray-300 max-w-md text-sm text-pretty">
              Performance-focused digital growth agency. Data-driven strategies that scale.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="#home" className="text-gray-300 hover:text-red-400 transition-colors text-sm">
                  Home
                </Link>
              </li>
              <li>
                <Link href="#services" className="text-gray-300 hover:text-red-400 transition-colors text-sm">
                  Services
                </Link>
              </li>
              <li>
                <Link href="#testimonials" className="text-gray-300 hover:text-red-400 transition-colors text-sm">
                  Testimonials
                </Link>
              </li>
              <li>
                <Link href="#team" className="text-gray-300 hover:text-red-400 transition-colors text-sm">
                  Team
                </Link>
              </li>
              <li>
          ...
          <div>
            <h4 className="font-bold text-base mb-4 text-white">Contact Information</h4>
            <div className="space-y-3">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <a href="tel:+1234567890" className="text-gray-300 hover:text-red-400 transition-colors text-sm">
                    0949 412 1734
                  </a>
                </div>
              </div>
